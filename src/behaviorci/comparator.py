...
class Comparator:
    ...
    def compute_effective_threshold(self, snapshot_id: str, base_threshold: float) -> float:
    ...
    def compare(
        ...
        if snapshot.model_name != self.embedder.model_name:
            raise ModelMismatchError(
                stored_model=snapshot.model_name, current_model=self.embedder.model_name
            )
